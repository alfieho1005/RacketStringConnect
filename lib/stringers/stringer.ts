...
const baseStringers: ReadonlyArray<SeedStringer> = [
  ...
  {
    id: "luxis-sport-mong-kok",
    slug: "luxis-sport-mong-kok",
    name: "凌獅運動用品專門店 Luxis Sport Net",
    description:
      "凌獅運動用品專門店成立於 2000 年，與本地 Yonex 官方供應商緊密合作，專注販售授權的 Yonex 羽毛球用品並與業界交流以提升服務品質，亦與多個在地商戶合作推廣羽毛球運動。\n" +
      "LuxisSport Ltd has been established since 2000, cooperating closely with the local Yonex official supplier to offer authorized Yonex badminton gear while partnering with professionals and businesses to elevate service levels and grow the sport in Hong Kong.",
    sports: ["badminton" as const],
    area: "mong-kok" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
  ...
  {
    id: "masters-racket-lai-chi-kok",
    slug: "masters-racket-lai-chi-kok",
    name: "Masters Racket",
    description:
      "於長沙灣（深水埗鄰近區域）的 Masters Racket 是專精網球拍穿線與器材調整的專業網球用品店，所在樓層寬敞、環境安靜，適合討論細節。\n" +
      "地址：九龍荔枝角長沙灣道 682-684 號 Trendy Centre 29 樓 07 室\n" +
      "營業時間：星期一至五 12:30 – 19:30，星期六 12:30 – 18:30，星期日及公眾假期休息",
    sports: ["tennis" as const],
    area: "lai-chi-kok" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    pricing: "Pricing available upon enquiry",
    sortId: 915,
  ...
  {
    id: "crescent-badminton-lai-chi-kok",
    slug: "crescent-badminton-lai-chi-kok",
    name: "新月羽毛球專業穿線",
    description:
      "專注羽毛球穿線，多種球線選擇及換護線釘服務。\n" +
      "不定時會係IG介紹唔同球線。\n" +
      "設有自助收取球拍服務，不受營業時間限制，彈性大。\n" +
      "到店前請whatsapp\n" +
      "地址: 荔枝角青山道479號麗昌工廠大廈701樓16號工作室",
    sports: ["badminton" as const],
    area: "lai-chi-kok" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
  ...
  {
    id: "jc-sport-lai-chi-kok",
    slug: "jc-sport-lai-chi-kok",
    name: "Jc.Sport",
    description:
      "🎾🏸網羽穿線服務\n" +
      "⚙️穿線機型號：\n" +
    ...
    sortId: 1,
    contact: {
      email: "jazzcheng2025@gmail.com",
      phone: "+85268758421",
      whatsapp: "+85268758421",
    },
    visibility: "active" as const,
  },
  {
    id: "moon-stringing-lai-chi-kok",
    slug: "moon-stringing-lai-chi-kok",
    name: "上弦●荔枝角 羽毛球拍穿線工作室@（香港羽毛球發展公司）Moon Stringing @Hong Kong Badminton Development Co.",
    description:
      "位於九龍荔枝角區開設羽毛球拍專門店提供特快即日羽毛球拍穿線服務（加急不另收費，最快1小時可取）。球線款式包括：Yonex、Victor、李寧 Li-Ning、Kizuna、Toalson、Mizuno，並提供 Yonex 球拍網購、羽毛球拍維修補拍服務、羽毛球拍保養更換線管連釘防塌墊片與手膠 Grip 服務及羽毛球拍出租服務。\n地址：九龍荔枝角青山道688號嘉名工廠大廈1樓035室（見OK688牌上樓梯 1樓正中央）［荔枝角 C 出口步行2分鐘］\n*穿線機型號：Victor C-7032Ultra",
    sports: ["badminton" as const],
    area: "lai-chi-kok" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
  ...
  },
  {
    ...
    description:
      "觀塘站 D4 出口步行 30 秒即可到達的飛騰羽毛球專門店 Leap Way Sports，提供完整球拍穿線與配件服務，營業時間也能配合上班族。\n" +
      "地址：觀塘工業中心三期 1 樓 E 室\n" +
      "營業時間：星期一至六 11:00 – 20:00（星期日休息）",
    sports: ["badminton" as const],
    area: "kwun-tong" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
  ...
  },
  {
    ...
    description:
      "官塘球拍穿線 JACKY SPORTS 位於觀塘工業中心第 4 期 11 樓 E 室，專注羽毛球拍與網球拍的穿線與維修。\n" +
      "地址：香港九龍觀塘道 436-446 號官工業中心第 4 期 11 樓 E 室\n" +
      "營業時間：每日 10:00 – 18:30（星期日 11:00 開始）",
    sports: ["badminton" as const],
    area: "kwun-tong" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
  ...
  {
    id: "rose-sports-southern",
    slug: "rose-sports-southern",
    name: "玫瑰體育 Rose Sports",
    description:
      "香港仔分店大規模的老牌體育用品店，主打羽球與網球穿線，師傅經驗老到，備有專業設備。",
    sports: ["badminton" as const, "tennis" as const],
    area: "aberdeen" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    pricing: "Pricing available upon enquiry",
    sortId: 919,
  ...
  {
    id: "southern-district-sports",
    slug: "southern-district-sports",
    name: "南區體育 Southern District Sports",
    description:
      "香港仔大道的街坊店，價格親民且靠近巴士總站，專注服務南區居民與學生的羽毛球穿線需求。",
    sports: ["badminton" as const],
    area: "aberdeen" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
  ...
  {
    id: "gutsy-sports-quarry-bay",
    slug: "gutsy-sports-quarry-bay",
    name: "Gutsy Sports (專業穿線工作室)",
    description:
      "鰂魚涌的 Gutsy Sports 係 GOSEN、ERSA 皆認可嘅張人工作室，專攻『張人』穿線法，備有頂級電子機確保磅數平均，WhatsApp 預約即可即穿。",
    sports: ["badminton" as const],
    area: "quarry-bay" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    pricing: "Pricing available upon enquiry",
    sortId: 921,
    contact: {
      instagram: "gutsysports",
      whatsapp: "+85296265122",
      phone: "+85296265122",
    },
    visibility: "active" as const,
  },
  {
    id: "mh-sports-chai-wan",
    slug: "mh-sports-chai-wan",
    name: "M&H Sports (羽家)",
    description:
      "柴灣的 M&H Sports 工作室手勢細緻、回覆迅速，可在 IG 查看新款羽毛球線，專注以客製化方式處理穿線。",
    sports: ["badminton" as const],
    area: "chai-wan" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    pricing: "Pricing available upon enquiry",
    sortId: 922,
    contact: {
      instagram: "mh_sports_hk",
      whatsapp: "+85263911993",
      phone: "+85263911993",
    },
    visibility: "active" as const,
  },
  {
    id: "wan-kee-quarry-bay",
    slug: "wan-kee-quarry-bay",
    name: "允記 Wan Kee",
    description:
      "太古城允記是提供穿線與裝備的連鎖選項，位置方便且可累積會員積分，建議先以電話確認師傅在場時間。",
    sports: ["badminton" as const],
    area: "quarry-bay" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
  ...
  {
    id: "bat-stringing-tuen-mun",
    slug: "bat-stringing-tuen-mun",
    name: "B.A.T Stringing (專業穿線工作室)",
    description:
      "屯門震寰路的 B.A.T Stringing 工作室主打羽毛球與網球穿線，WhatsApp 預約，注重磅數與細節，IG 分享完成品，支援當日交收。",
    sports: ["badminton" as const, "tennis" as const],
    area: "tuen-mun" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    pricing: "Pricing available upon enquiry",
    sortId: 924,
    contact: {
      instagram: "bat_stringing",
      whatsapp: "+85264355032",
      phone: "+85264355032",
    },
    visibility: "active" as const,
  },
  {
    id: "andy-sport-tuen-mun",
    slug: "andy-sport-tuen-mun",
    name: "Andy Sport Shop 安迪體育用品",
    description:
      "屯門市廣場附近的老牌體育用品店，提供一站式羽毛球配件與穿線服務，是市中心逛街時順路寄放球拍的好選擇。",
    sports: ["badminton" as const],
    area: "tuen-mun" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
  ...
  {
    id: "never-fault-tuen-mun",
    slug: "never-fault-tuen-mun",
    name: "Never Fault (Brian)",
    description:
      "屯門好景工業大廈內的 Never Fault (Brian)，以 Carousell 作為聯絡方式，專為本地羽毛球與網球愛好者提供細緻穿線服務。",
    sports: ["badminton" as const, "tennis" as const],
    area: "tuen-mun" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    ...
    sortId: 926,
    contact: {
      website: "https://www.carousell.com/never-fault",
    },
    visibility: "active" as const,
  },
  {
    id: "sis-racquet-tuen-mun",
    slug: "sis-racquet-tuen-mun",
    name: "SIS Racquet",
    description:
      "位於屯門壹號總站的 SIS Racquet，提供羽毛球與網球穿線與換線服務，適合近海運站與屯門站的球友。",
    sports: ["badminton" as const, "tennis" as const],
    area: "tuen-mun" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    ...
    sortId: 927,
    contact: {
      instagram: "sis_racquet",
      phone: "+85234603004",
      whatsapp: "+85234603004",
    },
    visibility: "active" as const,
  },
  {
    id: "sis-racquet-yuen-long",
    slug: "sis-racquet-yuen-long",
    name: "蘇迪曼球拍運動專門店 SIS Racquet Pro-Shop",
    description:
      "元朗的 SIS Racquet Pro-Shop 為 Li-Ning 及 Yonex 等品牌代理，提供羽毛球、網球與壁球穿線並熟悉各品牌磅數上限與手感。",
    sports: ["badminton" as const, "tennis" as const, "squash" as const],
    ...
    contact: {
      instagram: "sis_racquet",
      whatsapp: "+85268286893",
      phone: "+85268286893",
    },
    visibility: "active" as const,
  },
  {
    id: "goal-badminton-yuen-long",
    slug: "goal-badminton-yuen-long",
    name: "高標羽毛球專門店 Goal Badminton Pro Shop",
    description:
      "又新街邊嘅小店，陳生 Lai Sir 以穩定穿線手勢為名，店內器材齊全，係教練同球員間嘅交流基地，交收方便。",
    sports: ["badminton" as const],
    area: "yuen-long" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    ...
    sortId: 929,
    contact: {
      instagram: "goalbadminton",
      phone: "+85224703328",
    },
    visibility: "active" as const,
  },
  {
    id: "mister-keen-sports-yuen-long",
    slug: "mister-keen-sports-yuen-long",
    name: "Mister Keen Sports 堅體育",
    description:
      "位於光華廣場的 Yonex 官方授權店，IG 活躍分享最新線材動態，穿線過程靠嚴謹流程，對追求最新技術的球友很有吸引力。",
    sports: ["badminton" as const],
    area: "yuen-long" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    ...
    sortId: 930,
    contact: {
      instagram: "misterkeensports",
      whatsapp: "+85292262983",
      phone: "+85292262983",
    },
    visibility: "active" as const,
  },
  {
    id: "master-stringer-central",
    slug: "master-stringer-central",
    name: "Master Stringer (專業網球/羽毛球穿線 - 中環)",
    description:
      "坐落中環華威大廈的 Master Stringer 以職業級穿線設備聞名，雖然主打網球但羽毛球也同樣精準，WhatsApp 預約可做即日取拍。",
    sports: ["tennis" as const, "badminton" as const],
    area: "central" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: true,
    ...
    sortId: 931,
    contact: {
      instagram: "master_stringer",
      whatsapp: "+85292203383",
      phone: "+85292203383",
    },
    visibility: "active" as const,
  },
  {
    ...
    name: "Inspire Racket",
    description:
      "專業網球穿線，位於 T3 Tennis 室內網球館內，隨穿線之外亦有網球產品發售及四條室內發球機 lane 可供練習；穿線之後亦歡迎即場免費試拍。",
    sports: ["tennis" as const],
    area: "diamond-hill" as const,
    country: "hong-kong" as const,
    hasCertifiedStringers: false,
    pricing: "Pricing available upon enquiry",
    sortId: 4,
    contact: {
      email: "vitajamba5@gmail.com",
      whatsapp: "+85254095420",
      phone: "+85254095420",
    },
    visibility: "active" as const,
  },
